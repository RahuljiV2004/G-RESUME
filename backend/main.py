...
# def enhance_resume_text(resume_text: str, job_description: str):
#     try:
#         prompt = (
...
#             "-keep it short and dont exceed 400 words.\n"
...
# # Endpoint to receive PDF file and job description
...
#     enhanced_text = enhance_resume_text(pdf_text, job_description)
